...
@Entity
@Table(name = "t_mingshi")
public class MingShi extends BaseEntity{

	/**
	 * @Fields serialVersionUID : 序列标识
	 */
	
	private static final long serialVersionUID = -123214323457834536L;
	...
	private String shanChangKeCheng;//擅长课程 雅思 托福 JRE
