        ...
        <div class="col-xs-12 col-sm-9 col-md-8 col-sm-offset-2 col-md-offset-2 right_content">
            <div class="row tianXieXinXi">
                ...
                <div class="col-md-12 col-md-offset-3 content_jiChu">
                    <form class="form-horizontal" id="form" method="post" enctype="multipart/form-data" action="${path}/kecheng/add.shtml">
                        ...
                        <div class="form-group">
	                        ...
	                        <div class="col-sm-8 col-md-6">
	                        	<input class="form-control form_date" type="text" value="2015-01-01" id="beginTime" name="beginTime" data-date-format="yyyy-mm-dd" data-link-format="yyyy-mm-dd">
	                    	</div>
	                    </div>
                        <div class="form-group">
	                        <label for="endTime" class="col-sm-2 control-label">结束时间</label>
	                        <div class="col-sm-8 col-md-6">
	                        	<input class="form-control form_date" type="text" value="2015-12-31" id="endTime" name="endTime" data-date-format="yyyy-mm-dd" data-link-format="yyyy-mm-dd">
	                    	</div>
	                    </div>
	                    <div class="form-group">
                            <label for="tuiJianZhiShu" class="col-sm-2 control-label">推荐指数</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="tuiJianZhiShu" name="tuiJianZhiShu" placeholder="整数值 1-5" value="0">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="baoMingRenShu" class="col-sm-2 control-label">已经报名人数</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="baoMingRenShu" name="baoMingRenShu" placeholder="整数值" value="0">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="jiaoCai" name="jiaoCai">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="shiHeDuiXiang" class="col-sm-2 control-label">适合对象</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="shiHeDuiXiang" name="shiHeDuiXiang">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="baoFenChengNuo" class="col-sm-2 control-label">保分承诺</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="baoFenChengNuo" name="baoFenChengNuo">
                            </div>
                        </div>
                         <div class="form-group">
                            <label for="keChengFenXi" class="col-sm-2 control-label">课程分析</label>
                            <div class="col-sm-8 col-md-6">
                                <textarea class="form-control" rows="7" id="keChengFenXi" name="keChengFenXi"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
