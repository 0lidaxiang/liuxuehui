        ...
        <div class="col-xs-12 col-sm-9 col-md-8 col-sm-offset-2 col-md-offset-2 right_content">
            <div class="row tianXieXinXi">
                ...
                <div class="col-md-12 col-md-offset-3 content_jiChu">
                    <form class="form-horizontal" id="form" method="post" enctype="multipart/form-data" action="${path}/student/add.shtml">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-6">
                            	<input type="text" class="form-control" id="chengJi" name="chengJi" placeholder="eg：雅思8分">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="offer" class="col-sm-2 control-label">收到的offer</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="offer" name="offer" placeholder="多个以顿号隔开 ">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="jinRuXueXiao" class="col-sm-2 control-label">入读的学校</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="jinRuXueXiao" name="jinRuXueXiao">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="jinRuXueXiaoPingJi" class="col-sm-2 control-label">进入的留学学校评级分数</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="jinRuXueXiaoPingJi" name="jinRuXueXiaoPingJi" placeholder="整数 1-10 " value="0">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="xueXiao" name="xueXiao" placeholder="多个以顿号隔开">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="zhuanYe" class="col-sm-2 control-label">在读专业</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="zhuanYe" name="zhuanYe">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="pingJunChengJi" class="col-sm-2 control-label">在学校各科的平均成绩</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="pingJunChengJi" name="pingJunChengJi">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="anLiJianJie" class="col-sm-2 control-label">案例简介</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="anLiJianJie" name="anLiJianJie">
                            </div>
                        </div>
                         <div class="form-group">
                            <label for="anLiFenXi" class="col-sm-2 control-label">案例分析</label>
                            <div class="col-sm-8 col-md-6">
                                <textarea class="form-control" rows="7" id="anLiFenXi" name="anLiFenXi"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
