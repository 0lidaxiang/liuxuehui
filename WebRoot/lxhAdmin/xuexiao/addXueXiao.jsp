        ...
        <div class="col-xs-12 col-sm-9 col-md-8 col-sm-offset-2 col-md-offset-2 right_content">
            <div class="row tianXieXinXi">
                ...
                <div class="col-md-12 col-md-offset-3 content_jiChu">
                    <form class="form-horizontal" id="form" method="post" enctype="multipart/form-data" action="${path}/xuexiao/add.shtml">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-6">
                                <textarea class="form-control" rows="5" id="jianjie" name="jianjie"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="pinjia" name="pinjia" placeholder="填写1-5的整数">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="shanchangguojia" class="col-sm-2 control-label">擅长国家</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="shanchangguojia" name="shanchangguojia" placeholder="多个国家以顿号隔开">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="suoZaiChengShi" class="col-sm-2 control-label">所在城市</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="suoZaiChengShi" name="suoZaiChengShi" placeholder="多个形式以顿号隔开">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="leiXing" class="col-sm-2 control-label">院校类型</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="leiXing" name="leiXing" placeholder="私立/公立">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="weekZhaoShengShu" class="col-sm-2 control-label">周招生数</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="weekZhaoShengShu" name="weekZhaoShengShu" placeholder="整数">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="monthZhaoShengShu" class="col-sm-2 control-label">月招生数</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="monthZhaoShengShu" name="monthZhaoShengShu" placeholder="整数">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="yearZhaoShengShu" class="col-sm-2 control-label">年招生数</label>
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="yearZhaoShengShu" name="yearZhaoShengShu" placeholder="整数">
                            </div>
                        </div>
                        <div class="form-group">
