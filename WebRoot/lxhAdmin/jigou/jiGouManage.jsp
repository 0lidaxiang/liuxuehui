    ...
    <div class="row ziXunJiGou">
        ...
        <div class="col-md-10 col-md-offset-1 head-search">
            ...
            <div class="search-tiaoJian text-center">
            	<a href="${path}/lxhAdmin/jigou/addJiGou.jsp" class="btn btn-success" target="_blank">添加留学机构</a>
            </div>
        </div>
        <div class="col-md-10 col-md-offset-1">
            	...
            	<div class="col-sm-12 jiGou-content">
	                ...
	                <div class="col-sm-7 content-miaoShu">
	                    ...
	                    <div class="col-sm-12 text-center">
	                        <a class="btn btn-default" href="${path}/jigou/content.shtml?jiGouGuid=${jiGou.guid}" style="padding-left:20px;padding-right:20px;">去看看</a>
	                        <a class="btn btn-success" href="${path}/jigou/goUpdateJiGou.shtml?jiGouGuid=${jiGou.guid}" style="padding-left:20px;padding-right:20px;">修改</a>
	                        <a class="btn btn-danger delete" id="${jiGou.guid}" style="padding-left:20px;padding-right:20px;">删除</a>
	                    </div>
	                </div>
	            </div>
            </c:forEach>
...
<script type="text/javascript">
	$(function(){
		$(".delete").click(function(){
			var jiGouGuid = $(this).attr("id");
			if(confirm("确定要删除数据吗")){
				$.post("${path}/jigou/delete.shtml",{"jiGouGuid":jiGouGuid},function(data){
					var msg = data.msg;
					if(msg=="success"){
						$("#"+jiGouGuid).parent().parent().parent().fadeOut("slow");
					}else if(msg=="fail"){
						alert("系统异常，删除失败");
					}
				});
