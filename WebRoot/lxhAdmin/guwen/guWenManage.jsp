    ...
    <div class="row ziXunGuWen">
        ...
        <div class="col-md-10 col-md-offset-1 head-search">
            ...
            <div class="search-tiaoJian text-center">
            	<a href="${path}/lxhAdmin/guwen/addGuWen.jsp" class="btn btn-success" target="_blank">添加咨询顾问</a>
            </div>
        </div>
        <div class="col-md-10 col-md-offset-1">
        		...
        		<div class="col-sm-12 guWen-content" >
	                ...
	                <div class="col-sm-7 content-miaoShu">
	                	<div class="col-sm-12" style="padding-left: 0px;">
	                		<a href="${path}/guwen/content.shtml?guWenGuid=${guWen.guid}"><h4 style="display: inline;">${guWen.name}</h4></a>
		                   	<a class="btn btn-danger delete" id="${guWen.guid}" style="padding:0px 20px 0px 20px;float: right;">删除</a>
		                    <a class="btn btn-success" href="${path}/guwen/goUpdate.shtml?guWenGuid=${guWen.guid}" style="padding:0px 20px 0px 20px;float: right;margin-right: 10px;">修改</a>
	                	</div>
...
<script type="text/javascript">
	$(function(){
		$(".delete").click(function(){
			var guWenGuid = $(this).attr("id");
			if(confirm("确定要删除数据吗")){
				$.post("${path}/guwen/delete.shtml",{"guWenGuid":guWenGuid},function(data){
					var msg = data.msg;
					if(msg=="success"){
						$("#"+guWenGuid).parent().parent().parent().fadeOut("slow");
					}else if(msg=="fail"){
						alert("系统异常，删除失败");
					}
				});
