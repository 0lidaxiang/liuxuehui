        ...
        <div class="col-xs-12 col-sm-9 col-md-8 col-sm-offset-2 col-md-offset-2 right_content">
            <div class="row tianXieXinXi">
                ...
                <div class="col-md-12 col-md-offset-3 content_jiChu">
                    <form class="form-horizontal" id="form" method="post" enctype="multipart/form-data" action="${path}/guwen/add.shtml">
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label">顾问姓名<span style="color: red;vertical-align:middle;font-size: 20px;"> *</span></label>
                        ...
                        <div class="form-group">
                            <label for="photo" class="col-sm-2 control-label">列表图片<span style="color: red;vertical-align:middle;font-size: 20px;"> *</span></label>
                            <div class="col-sm-8 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-6">
                                <input type="text" class="form-control" id="shanChangZhuanYe" name="shanChangZhuanYe" placeholder="多个形式以顿号隔开">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label for="jieshao" class="col-sm-2 control-label">详细介绍<span style="color: red;vertical-align:middle;font-size: 20px;"> *</span></label>
                            <div class="col-sm-8 col-md-6">
