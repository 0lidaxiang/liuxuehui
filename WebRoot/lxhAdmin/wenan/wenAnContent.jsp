...
<div class="container">
    <div class="row weiZhi">
        <div class="col-md-10 col-md-offset-1">
            <span>所在位置：<a href="${path}/wenan/more.shtml?pageNo=1">咨询文案</a>/${wenAn.name}</span>
        </div>
    </div>
</div>
    ...
    <div class="col-md-10 col-md-offset-1 image-content">
        <div class="col-sm-8">
            ...
            <div class="text-content">
                <div class="jieShao">
                    <p>${wenAnContent.jieShao}</p>
                </div>
                <hr>
                <div class="jieShao">
                    <p>电话：${wenAnContent.dianHua}</p>
                    <p>QQ：${wenAnContent.QQ}</p>
                    <p>微信：${wenAnContent.weiXin}</p>
                    <p>博客：<a href="${wenAnContent.boKeUrl}">${wenAnContent.boKeUrl}</a></p>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
...
<script type="text/javascript">
	$(function(){
		$(".big-img").css("background-image","url(${path}/static/uploadImg/wenan/content/${wenAnContent.pictureName})");
	});
</script>
</body>
</html>