...
<div class="container">
    <div class="row weiZhi">
        <div class="col-md-10 col-md-offset-1">
            <span>所在位置：<a href="${path}/xuexiao/more.shtml?pageNo=1">培训学校</a>/${xueXiao.name}</span>
        </div>
    </div>
</div>
    ...
    <div class="col-md-10 col-md-offset-1 image-content">
        <div class="col-sm-8">
            ...
            <div class="text-content">
                <div class="jieShao">
                    <p>${xueXiaoContent.jieShao}</p>
                </div>
                <hr>
                <div class="jieShao">
                    <p>电话：${xueXiaoContent.dianHua}</p>
                    <p>地址：${xueXiaoContent.address}</p>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
...
<script type="text/javascript">
	$(function(){
		$(".big-img").css("background-image","url(${path}/static/uploadImg/xuexiao/content/${xueXiaoContent.pictureName})");
	});
</script>
</body>
</html>